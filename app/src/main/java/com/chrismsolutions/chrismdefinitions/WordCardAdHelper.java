...
/**
 * Created by Christian Myrvold on 03.01.2018.
 */

public class WordCardAdHelper extends ChrismAdHelper
{
    AdView mAdView;

    public WordCardAdHelper(Context context, boolean initHelper, boolean callback)
    {
